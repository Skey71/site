...
function makeGETRequest(url, callback) {
    return new Promise((resolve, reject) => {
        ...
        xhr.onload = () => resolve(callback(xhr.productText));
...
// Класс товара
class GoodItem {
    constructor(id, title = 'Товар', price = 'Цена', img = '../dist/img/no-image.jpg') {
        this.id = id;
        this.title = title;
        this.price = price;
        this.img = img;
...
class GoodsList {
    ...
    // Сделано, чтобы можно было менять значение извне
    fetchGoods(url) {
